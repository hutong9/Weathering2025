      ...
      <div class="container mx-auto md:py-10 w-full p-6">
        ...
        <div class="container mx-auto">
          <p class="text-white animate__animated animate__bounceInUp">
            　　“大陆风化前沿学术讨论会”由中国矿物岩石地球化学学会地表与生物地球化学专业委员会发起，旨在针对大陆风化领域的前沿科学问题开展深入讨论，推动多学科交叉地球系统科学研究，促进重大科学问题的凝练与攻关。该会议每两年举办一次，首届会议已由南京大学表生地球化学教育部重点实验室于2023年在海南保亭顺利举办，会议涵盖风化研究方法指标、风化机制现代过程研究、风化与行星系统演化、风化与灾害、资源、环境等方面的50余个话题，来自国内外40余个科研机构的180余名代表参会。
          </p>
      ...
      <div class="container mx-auto md:py-10 w-full p-6">
        ...
        <div class="container mx-auto">
          <p class="animate__animated animate__bounceInUp">
            　　意义来自生命。研究意义的起源自然成为最有意义的研究。除了时空、物质基础和稳定有序空间环境以外,地球以碳水化物为基础的生命形式更是需要包括液态水的长期存在等诸多要素。这些支撑碳基生命出现和不断演进，并且最终产生意义的各种因子成为智慧生命所定义的宜居要素。
          </p>
          ...
          <p class=" animate__animated animate__bounceInUp">
            　　风化作用与宜居要素的紧密联系在本质上与地球圈层相互作用有关。生命的出现是圈层相互作用的结果，生命的演进适应地球圈层系统演化，生命本身也参与圈层相互作用。同时，大陆风化是岩石/矿物在水、气、生作用下的破碎分解过程，因而成圈层相互作用的重要纽带，记录了圈层相互作用的历史。如果以金代表岩石圈、木代表生物圈、水代表水圈、火代表大气圈、土代表土壤圈，风化过程则可以看成中国传统哲学金、木、水、火、土五大自然要素的相互作用。
          </p>


          <p class=" animate__animated animate__bounceInUp">
            　　多圈层相互作用下的风化研究必然涉及多学科。在很长时间内，中国风化研究群体分散在各个专门的学科群体中，包括自然地理学、土壤学、矿物学、构造地貌学、沉积与古环境学、地表地球化学、古海洋学、土壤与水环境科学等。但是，风化研究更需要学科交叉，需要地球系统科学思维路径。本质上,风化研究气候、大气成分、构造、地貌、岩性、生物等要素与风化过程之间相互作用与反馈的机理和过程，是实践地球系统科学的重要切入点。近年来，通过第二次青藏高原科考、基金委重大项目、国家重点研发项目等大型项目，中国风化研究群体已经具备相当规模，人才储备深厚，有望成为中国的优势研究领域。适时召开的大陆风化前沿讨论会(通过本专辑)，可以进一步凝聚大陆风化研究队伍、推动多学科交叉地球系统科学研究、促进重大科学问题的凝练与攻关。因此，在中国矿物岩石地球化学协会地表与生物地球化学专业委员会的支持下，有针对性地发起了本次讨论会(专辑)，并希望发展成为系列会议(专辑)。延安，地处黄土高原核心地带，黄土之下，是隐藏的红层地貌，巨厚红色砂砾岩层，经长期风化剥离和流水侵蚀，沿垂直节理发育成陡峭的奇岩怪石，是研究地质地貌的绝佳考察之地。
          </p>

          <p class=" animate__animated animate__bounceInUp">
            　　本次会议(专辑)提交的议题(摘要)和参会人员(作者和编辑)组成不但展现出了风化研究的多样性，更是体现了风化过程对宜居地球系统的支撑作用。议题(摘要)还展现出相当的前沿性和引领性，整体上可分为四个板块，分别如下:
          </p>
